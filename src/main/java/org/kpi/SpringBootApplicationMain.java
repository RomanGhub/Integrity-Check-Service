...
public class SpringBootApplicationMain {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        // Load a class
        Class<?> loadedClass = Class.forName("org.kpi.LoadableClass");
        ...
        // Load a class
        Class<?> loadedClass2 = Class.forName("org.kpi.IntegrityExecutor");
        // Get the class loader
...
//        parentClassLoader.loadClass("org.kpi.LoadableClass");

        // Load a class
        loadedClass = Class.forName("org.kpi.LoadableClass");
        // Get the class loader
